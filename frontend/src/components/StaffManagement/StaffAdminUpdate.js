...
export default class StaffAdminUpdate extends Component{
    ...
    axios.get(`http://localhost:8000/staff/${id}`).then((res)=>{
      if(res.data.success){
        this.setState({
          ...
          subject:res.data.staff.subject,
          qulification:res.data.staff.qulification,
          phonenumber:res.data.staff.phonenumber,
  ...
  render(){
    return(
      ...
      <div className="col-md-8 mt-4 mx-auto">
        <h1 className="h3 mb-3 font-weight-normal" style={{color: 'yellow'}}>Edit Member Details</h1>
